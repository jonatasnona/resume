...
\section{Experiência}
\cventry{Atualmente}{Programador Pleno 4 - Departamento de Frontend}{Neemu}{Manaus/AM, Brasil}{}{
Participação no desenvolvimento de uma API REST para o produto \textbf{Cockpit Dashboard},
