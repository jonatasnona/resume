...
\section{Experiência}
\cventry{Atualmente}{Programador Sênior 1 - Departamento de Infraestrutura}{Neemu}{Manaus/AM, Brasil}{}{
...
Participação no desenvolvimento e arquitetura de uma API REST para o produto \textbf{Cockpit Dashboard},
desenvolvido com NodeJS, Python, MySQL e Redis.
\newline{}}

\cventry{}{Programador Pleno 4 - Departamento de Big Data}{Neemu}{Manaus/AM, Brasil}{}{
Criação de unittests para validação de documentos JSON. Modelagem dos documentos no MongoDB.
...
\section{Educação}
\cventry{2014}{Bacharelando em Ciência da Computação}{FUCAPI}{Manaus/AM, Brasil}{}{Status: Cursando\newline{}}

\section{Cursos}
\cventry{2014}{\faSpinner \hspace{1pt} Create and Manage APIs}{}{\href{https://community.apigee.com/learn/create-and-manage-apis}{Apigee Community}}{}{Online course lectured by Michael Bissell.\newline{}}
