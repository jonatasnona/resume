...
\textbf{Projetos:}
    \begin{itemize}
        \item Person Of Interest - serviço que detecta em real time qual sinal (programa) ao vivo uma personalidade de interesse apareceu e notifica sua aparição usando algoritmos de face detection.
        \item Thumbs Analyzer - serviço de checagem de DVR da plataforma de vídeos ao vivo.
        \item Placeholder Analyzer - serviço que checa se um dado sinal (programa) é um tapume ou video congelado usando similaridade de imagens.
...
\cvline{Web Server}{Nginx, NodeJS$\bigstar$}
\cvline{Programming}{JavaScript$\bigstar$, Python, Java, C}
\cvline{Networking}{WebSockets, HTTP, TCP/IP, UDP}
\cvline{Frameworks}{jQuery$\bigstar$, Bootstrap}
\cvline{Databases}{Redis$\bigstar$, MongoDB, MySQL}
