...
\cvline{Programming}{C, Java, PHP, Python, NodeJS$\bigstar$, Shell script}
\cvline{Frameworks}{jQuery$\bigstar$, Bootstrap}
\cvline{Databases}{MySQL, PostgreSQL, Redis, MongoDB}
\cvline{VCS}{Git$\bigstar$, SVN}
\cvline{Build Tools}{Automake, Autoconf, ant, Maven, Bower,
Jenkins, Fabric}
